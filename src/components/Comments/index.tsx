...
export default function Comments() {
  ...
  const [ commentsState, setCoomentsState ] = useState<number>(0);
  ...
  //           event handler: 댓글 작성 유저 확인 이벤트 처리          //
        ...
        <div className='comments-reply-container'>
            ...
            <div className='comments-reply-comment-input-box'>
                <div className='comments-reply-comment-input-container'>
                    <textarea form='comments-reply-textarea' placeholder='답글을 작성해주세요.'maxLength={300} onClick={onSaveButtonClickHandler} /></div>
    ...
    return (
      <div id='comments-wrapper'>
        <div className='comments-container'>
          ...
          {commentsState === 0 ? (
            <div className='no-write-comment-state-box'>
              <div className='no-registered-text'>{'등록된 댓글이 없습니다.'}</div>
          </div>
          ) : (
        ...
        <div className='comments-reply-comment-input-box'>
                <div className='comments-reply-comment-input-container'>
                    <textarea form='comments-reply-textarea' placeholder='댓글을 작성해주세요.'maxLength={300} onClick={onSaveButtonClickHandler} /></div>
                <div className='comments-reply-comment-button'><button>{'등록'}</button></div>
            </div>
      </div>
    );
